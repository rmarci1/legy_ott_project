...
export default function ProfilePage(){
    ...
    return     <div className="md:min-h-screen flex w-full flex-col p-3  overflow-y-scroll  [&::-webkit-scrollbar]:w-1
        ...
        <div className=" flex flex-col w-full p-3 items-center text-center ">
            ...
            <div className="flex text-2xl flex-row text-center md:w-1/3 md:min-w-fit min-w-[60%] justify-between">
